...
import { HistoryView } from './components/HistoryView'; // Import componenta noua
...
const SocialSparkApp: React.FC = () => {
  ...
  const handleImageSelected = (url: string) => {
      if (activePostIdForImage) {
          ...
          // Dacă adăugăm imagine la un post existent, ar fi bine să îl salvăm din nou sau să actualizăm (pentru MVP salvăm duplicat sau lăsăm așa)
          // Ideal ar fi un updatePostInHistory, dar pentru simplitate lăsăm așa momentan.
      } else {
  ...
  return (
    // AICI TRIMITEM PROPS-URILE DE NAVIGARE
    <MainLayout 
    ...
    >
        ...
        {/* RENDERING CONDIȚIONAL: CREATE vs HISTORY */}
        {currentView === 'history' ? (
            <HistoryView />
        ) : (
