...
import { Sparkles, Fingerprint, Repeat, ImageIcon, Database, Globe, Zap, UserCheck, Search, Wand2, Lock, Smartphone, Check, ChevronDown, ChevronUp, Layers } from 'lucide-react';
...
import { SocialSupportButtons as SocialIconsCompact } from './SocialSupportButtons';

// ... (keep all the PLANS and PLAN_EXTENSIONS data)
